...
const STAT_PILLS = [
  ...
  { num: "+40%", label: "Conversión" },
  { num: "24/7", label: "Automatizado" },
] as const;

export function HeroCRMs({
  onCtaClick,
  ctaHref = "#diagnostico",
}: HeroCRMsProps) {
  ...
  return (
    <section
      aria-label="Hero — CRMs a la medida de tu operación"
      ...
      <div className="relative z-10 w-full container-custom px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <motion.a
            ...
            aria-label="Agendar diagnóstico de CRM"
