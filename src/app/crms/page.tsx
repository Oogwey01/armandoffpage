...
import { HeroCRMs } from "@/components/sections/HeroCRMs";
import { ScrollProgress } from "@/components/common/ScrollProgress";
import { FloatingActions } from "@/components/ui/FloatingActions";
import { ContentIntroSkeleton } from "@/components/ui/Skeletons";
import { useFormModal } from "@/hooks/useFormModal";
import { CloseIcon } from "@/components/common/Icons";

// ── Dynamic imports para below-fold — reduce JS inicial ──
const CRMIntro = dynamic(
  () =>
    import("@/components/sections/CRMIntro").then((m) => ({
      default: m.CRMIntro,
    })),
  { loading: () => <ContentIntroSkeleton />, ssr: false }
);
const CRMShowcase = dynamic(
  () =>
    import("@/components/sections/CRMShowcase").then((m) => ({
      default: m.CRMShowcase,
    })),
  { ssr: false }
);
  ...
  return (
    <>
      ...
      <main className="bg-brand-black min-h-screen">
        {/* Hero */}
        <HeroCRMs ctaHref="#diagnostico" onCtaClick={open} />
        <SectionDivider />
        ...
        <section className="relative py-16 md:py-24 bg-brand-black overflow-hidden">
          ...
          <div className="relative z-10 container-custom px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <br />
              ORGANÍZALAS{" "}
              <span className="text-brand-beige">ANTES QUE COLAPSEN.</span>
            </motion.h2>
            ...
            >
              Sin sistema, cada venta nueva es un incendio que apagar.
            </motion.p>

            {/* Problem cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 max-w-4xl mx-auto">
              {[
                "Tus leads se pierden entre hojas de Excel, WhatsApp y correos sueltos",
                "No sabes en qué punto del embudo abandona cada cliente",
                "Repites tareas manuales que un sistema podría automatizar",
                "No tienes reportes claros para decidir dónde invertir el siguiente peso",
              ].map((problem, index) => (
                <motion.div
                  key={problem}
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-16 md:py-20 bg-brand-black">
          <AnimateOnScroll className="container-custom">
            ...
            <h2 className="font-barlow font-black text-3xl sm:text-4xl md:text-5xl uppercase leading-[0.95] tracking-tight text-white text-center mb-3">
              LO QUE TE CUESTA{" "}
              <span className="text-brand-beige">HACERLO FRAGMENTADO</span>
            </h2>

            <p className="font-montserrat text-sm md:text-base text-gray-400 font-light text-center mb-10 md:mb-12 max-w-2xl mx-auto">
              Si hoy intentaras armar el stack por tu cuenta, esto es lo que estarías pagando mes con mes.
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 max-w-5xl mx-auto">
              ...
              <div className="bg-white/[0.02] border border-white/10 rounded-2xl overflow-hidden">
                ...
                <ul className="divide-y divide-white/5">
                  {[
                    { service: "Suscripción HubSpot / Salesforce", price: "$1,500 – $5,000 / mes" },
                    { service: "Integrador externo", price: "$800 – $3,000 / mes" },
                    { service: "Licencias por usuario", price: "$300 – $1,200 / mes" },
                    { service: "Consultor que entienda tu negocio", price: "Difícil de encontrar", highlight: true },
              ...
              <div className="bg-white/[0.02] border border-brand-beige/30 rounded-2xl overflow-hidden">
                ...
                <div className="px-5 py-5 border-b border-white/5 flex items-baseline gap-3">
                  ...
                  <p className="font-montserrat text-sm text-gray-400 font-light">
                    inversión · $0 por usuario
                  </p>
                </div>
                <ul className="divide-y divide-white/5">
                  {[
                    "Diseñado para tu proceso real",
                    "Código y datos propios",
                    "Sin costo por usuario adicional",
                    "Integrado con Shopify / Meta / WhatsApp",
                  ].map((feature) => (
        ...
        <section id="diagnostico" className="relative px-4 sm:px-6 lg:px-8 py-20 md:py-28 bg-brand-black overflow-hidden">
          {/* Background orb */}
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
            <motion.div
              className="absolute rounded-full"
              style={{
                ...
                background: "radial-gradient(ellipse, rgba(200,157,105,0.18) 0%, transparent 70%)",
                filter: "blur(70px)",
              }}
          ...
          <AnimateOnScroll className="relative z-10 container-custom text-center">
            <p className="font-barlow font-bold text-xs tracking-[0.3em] uppercase text-[#8f0000] mb-4">
              Siguiente paso
            </p>
            ...
            <h2 className="font-barlow font-black text-3xl sm:text-4xl md:text-5xl lg:text-6xl uppercase leading-[0.95] tracking-tight text-white mb-5 max-w-3xl mx-auto">
              DISEÑEMOS TU CRM{" "}
              <span className="text-brand-beige">A LA MEDIDA.</span>
            </h2>

            <p className="font-montserrat text-sm md:text-base text-gray-400 font-light mb-10 max-w-xl mx-auto">
              En 30 minutos identificamos qué procesos vale la pena automatizar primero.
              Sin compromiso.
            </p>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-16 md:py-20 bg-brand-black">
          <AnimateOnScroll className="container-custom">
            ...
            <h2 className="font-barlow font-black text-3xl sm:text-4xl md:text-5xl uppercase leading-[0.95] tracking-tight text-white text-center mb-10 md:mb-12">
              TRABAJAMOS CON OPERACIONES QUE VAN EN{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 max-w-5xl mx-auto">
              ...
              <div className="bg-white/[0.02] border border-brand-beige/30 rounded-2xl overflow-hidden">
                ...
                <ul className="divide-y divide-white/5">
                  {[
                    { label: "Operación con tracción", desc: "Tienes ventas consistentes y quieres dejar de depender de Excel" },
                    { label: "+5 leads/día sin sistema", desc: "Recibes prospectos de varios canales y se te escapan" },
                    { label: "Visión de inversión", desc: "Entiendes que automatizar hoy te ahorra un equipo mañana" },
                    { label: "Equipo que crece", desc: "Quieres que cada persona nueva arranque con el proceso correcto" },
                  ].map(({ label, desc }) => (
              ...
              <div className="bg-white/[0.02] border border-white/10 rounded-2xl overflow-hidden">
                ...
                <ul className="divide-y divide-white/5">
                  {[
                    { label: "Buscas plantilla genérica", desc: "Prefieres adaptar tu operación a un software enlatado" },
                    { label: "Sin claridad de proceso", desc: "No sabes cómo entran tus clientes ni cómo cierras ventas" },
                    { label: "Esperas resultados sin onboarding", desc: "No estás dispuesto a dedicar tiempo a configurar el sistema" },
                  ].map(({ label, desc }) => (
                    <li key={label} className="flex items-start gap-3 px-5 py-4">
